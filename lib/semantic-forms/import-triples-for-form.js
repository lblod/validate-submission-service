/*
 * Disclaimer this is *EDITED* COPYPASTA from https://github.com/lblod/frontend-meldingsplichtige-api/blob/master/app/utils/import-triples-for-form.js
 * It is a divergent version of the copied one, because there are currently issues with some of the es6 features used in the original one
 * and the node/babel config from mu-javascript-template.
 * TODO 1: update this mu-javascript template to the latest version of node and babel.
 * TODO 2: extract this code to an npm package
 */
