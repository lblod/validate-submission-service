...
class Submission {
  ...
  async process() {
    try {
      ...
      const documentType = getDocumentTypeFromSubmission(this.submittedResource, formBuilderOptions.store, triples);
...
function getDocumentTypeFromSubmission(documentUri, store, triples) {
