...
/**
 * Get form data used to construct in the form of a submission document in TTL format.
 *
 * @param {string} submissionDocument URI of the submitted document to get the meta data for
 * @return {string} TTL with form data for the given submission document
 */
async function getFormTtl(submissionDocument) {
