...
async function getSourceTtl(submissionDocument) {
  ...
  forkingStore.loadDataWithAddAndDelGraph(this.source || '', graph, this.additions || '', this.removals || '', 'text/turtle');
 ...
 */
async function submitDocument(submissionDocument, triples) {
